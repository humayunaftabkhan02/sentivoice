        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-6 sm:mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0">
            <div>
              ...
              <p className="text-gray-600 text-sm sm:text-base">Manage maintenance mode and announcements</p>
            </div>
          ...
          <div className="mb-6 flex gap-3">
            <button
              onClick={handleSave}
              disabled={saving}
              className="bg-blue-600 hover:bg-blue-700 disabled:bg-blue-400 text-white px-4 sm:px-6 py-2 rounded-lg text-sm sm:text-base font-medium shadow transition duration-200"
            >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-8">
            {/* Maintenance Mode */}
            <div className="bg-white rounded-xl shadow-lg overflow-hidden p-4 sm:p-8">
              <h3 className="text-base sm:text-lg font-semibold mb-4">🛠️ Maintenance Mode</h3>
              <div className="flex items-center justify-between mb-4">
                <span className="text-xs sm:text-sm font-medium">Enable Maintenance Mode</span>
                <ToggleSwitch
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden p-4 sm:p-8">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 space-y-3 sm:space-y-0">
                <h3 className="text-base sm:text-lg font-semibold">📢 Announcements</h3>
                <button
                  onClick={() => {
                    setShowAnnouncementForm(true);
                    setEditingAnnouncement(null);
                  ...
                  className="bg-blue-600 hover:bg-blue-700 text-white px-3 sm:px-4 py-2 rounded-lg text-xs sm:text-sm font-medium shadow transition duration-200 flex items-center gap-2"
                >
                  <FaPlus /> New
                </button>
              </div>
                ...
                <div className="mb-6 p-3 sm:p-4 bg-gray-50 rounded-lg">
                  ...
                  <form onSubmit={handleAnnouncementSubmit} className="space-y-3">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      ...
                      <div>
                        <label className="block text-xs sm:text-sm font-medium mb-1">End Date (Optional)</label>
                        <input
                          type="datetime-local"
                    ...
                    <div className="flex flex-col sm:flex-row gap-2">
                      <button
                        type="submit"
                        className="bg-blue-600 hover:bg-blue-700 text-white px-3 sm:px-4 py-2 rounded-lg text-xs sm:text-sm font-medium shadow transition duration-200"
                      >
                      ...
                      <button
                        ...
                        className="bg-gray-500 hover:bg-gray-600 text-white px-3 sm:px-4 py-2 rounded-lg text-xs sm:text-sm font-medium shadow transition duration-200"
                      >
                        Cancel
                      </button>
                    </div>
              ...
              <div className="space-y-3">
                {announcements.length === 0 ? (
                  <p className="text-gray-500 text-xs sm:text-sm">No announcements found.</p>
                ) : (
                    ...
                    <div key={announcement._id} className="p-3 bg-gray-50 rounded-lg">
                      <div className="flex items-start justify-between">
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-gray-900 text-xs sm:text-sm mb-1 break-words">{announcement.message}</p>
                          ...
                          <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 text-xs text-gray-500">
                            ...
                            {announcement.endDate && (
                              <div className="flex items-center gap-1">
                                <FaClock />
                                <span className="truncate">Ends: {formatDate(announcement.endDate)}</span>
                              </div>
                            )}
                          </div>
                        </div>
