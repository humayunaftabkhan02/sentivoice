          ...
          <div className="p-6">
            {loading ? (
              ...
              <div className="space-y-4">
                ...
                {showAddForm && (
                  <div 
                    className="border-2 border-green-200 rounded-lg p-6 bg-green-50 shadow-lg"
                  >
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center space-x-3">
                        <div className="p-2 bg-green-100 rounded-lg">
                          <FaPlus className="text-green-600 w-5 h-5" />
                        </div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center justify-end space-x-3 pt-4 border-t border-green-200">
                        <button
                          onClick={handleCancelAdd}
                ...
                {settings.map((setting) => (
                  <div key={setting._id} className="border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex items-center space-x-2">
                            <button
                              onClick={handleSave}
                              disabled={loading}
                              className="flex items-center space-x-2 px-3 py-1 text-sm font-medium text-white bg-green-600 rounded-lg hover:bg-green-700 transition-colors disabled:opacity-50"
                            >
                              {loading ? (
                                <FaSpinner className="animate-spin w-4 h-4" />
                              ) : (
                            ...
                            <button
                              ...
                              className="flex items-center space-x-2 px-3 py-1 text-sm font-medium text-gray-700 bg-gray-100 rounded-lg hover:bg-gray-200 transition-colors"
                            >
                      ...
                      <div>
                        <div className="flex items-center justify-between mb-4">
                          <div className="flex items-center space-x-3">
                            ...
                            <div>
                              ...
                              <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium border ${getStatusBadge(setting.isActive)}`}>
                          ...
                          <div className="flex items-center space-x-2">
                            ...
                            <button
                              ...
                              disabled={loading}
                              className="flex items-center space-x-2 px-3 py-1 text-sm font-medium text-red-700 bg-red-100 rounded-lg hover:bg-red-200 transition-colors disabled:opacity-50"
                            >
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                          <div>
                            ...
                            <p className="text-gray-900">{setting.accountName}</p>
                          </div>
                          
                          <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">Account Number</label>
                            <p className="text-gray-900 font-mono">{setting.accountNumber}</p>
                          </div>
                          
                          <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">Amount</label>
                            <p className="text-2xl font-bold text-green-600">{setting.amount.toLocaleString()} PKR</p>
                          </div>
